...
class Enemy extends SpriteComponent
    with CollisionCallbacks, HasGameReference<AmelShipGame> {
  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    if (other is Bullet) {
      ...
      // reduce health by level of bullet times 10, with weapon multiplier.
  ...
  // Method to apply damage from different weapon types
  ...
  void destroy() {
    ...
    // Generate 20 colorful circle particles with random speed and acceleration,
    ...
    final particleColor = particleColors[Random().nextInt(particleColors.length)];
